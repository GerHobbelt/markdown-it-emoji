...
const __filename$1 = url.fileURLToPath((typeof document === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : (document.currentScript && document.currentScript.src || new URL('markdownItEmoji.js', document.baseURI).href)));

const __dirname$1 = path__default['default'].dirname(__filename$1);

const emojies_defs = JSON.parse(fs__default['default'].readFileSync(path__default['default'].normalize(path__default['default'].join(__dirname$1, './lib/data/full.json')), 'utf8'));
...
//# sourceMappingURL=markdownItEmoji.js.map
