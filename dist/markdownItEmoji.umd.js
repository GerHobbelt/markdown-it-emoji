...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('path'), require('fs'), require('url')) :
  typeof define === 'function' && define.amd ? define(['path', 'fs', 'url'], factory) :
  (global = global || self, global.markdownitEmoji = factory(global.path, global.fs, global.url));
}(this, (function (path, fs, url) { 'use strict';
  ...
  const __filename = url.fileURLToPath((typeof document === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : (document.currentScript && document.currentScript.src || new URL('markdownItEmoji.umd.js', document.baseURI).href)));
